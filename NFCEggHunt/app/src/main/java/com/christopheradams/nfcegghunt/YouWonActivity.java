...
public class YouWonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /***************************** Play a Local Video ********************************/
        final VideoView videoView = (VideoView) findViewById(R.id.videoViewYouWon);
        ...
        videoView.setVideoPath("android.resource://com.christopheradams.nfcegghunt/raw/kenziewon");
        ...
        Button buttonPlayAgain2 =(Button)findViewById(R.id.buttonPlayAgain2);

        //Setup a click listener. Set the XML file for button onClick to go to onClick:
        buttonPlayAgain2.setOnClickListener(
